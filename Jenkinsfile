 ...
 stage ("Deploy Application on Azure Kubernetes Service")
 {
  switch (env.BRANCH_NAME) {
    ...
    case "canary":
        ...
        sh("kubectl --namespace=canary apply -f whoami/services/")
        sh("kubectl --namespace=canary apply -f whoami/canary/")
    ...
    case "master":
        ...
        sh("kubectl create ns production")
        sh("kubectl --namespace=canary apply -f whoami/services/")
        sh("kubectl --namespace=canary apply -f whoami/production/")
